// Code generated by the Encore v1.7.2 client generator. DO NOT EDIT.
...
export namespace user {
  ...
  export class ServiceClient {
    ...
    /**
     * BeforeCreateWebhook accepts webhooks from Firebase when a user is created.
     */
    public async BeforeCreateWebhook(
      params: BeforeCreateWebhookParams
    ): Promise<void> {
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "airbnb-mkg2-Generated-TS-Client (Encore/v1.7.2)",
    };
